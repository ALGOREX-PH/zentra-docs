...
Drop the four White-Belt submission screenshots here, captured from your own
Freighter testnet session on `/app`:

| File | What to capture |
| --- | --- |
| `connected.png` | The wallet **connected** — the address pill + green dot in the header. |
